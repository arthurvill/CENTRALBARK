...
class ResultController extends Controller
{
    ...
    {
        return view('staff.result.create', [
            'booking' => $booking
        ]);
    }
    ...
    public function store(ResultRequest $request, Booking $booking, ImageUploadService $service)
    {
        ...
        return to_route('staff.bookings.show', $booking)->with('success', 'Result Added Successfully');
    }

    public function show(Booking $booking, Result $result)
    {
        return view('staff.result.show', [
            'booking' => $booking,
            'result' => $result
        ]);
    }
    ...
    public function update(ResultRequest $request, Booking $booking, Result $result, ImageUploadService $service)
    {
        ...
        return to_route('staff.bookings.show', $booking)->with('success', 'Result Updated Successfully');
    }
