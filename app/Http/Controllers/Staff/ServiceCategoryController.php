...
class ServiceCategoryController extends Controller
{
    public function index()
    {
                    ...
                    $btn = "
                        <div class='dropdown'>
                            ...
                            <div class='dropdown-menu dropdown-menu-right dropdown-menu-arrow'>
                                ...
                                <a class='dropdown-item' href='javascript:void(0)' onclick='c_destroy($row->id,`staff.service_categories.destroy`,`.service_category_dt`)'>Delete</a>
                            </div>
                        </div> ";
        ...
        return view('staff.service_category.index');
    }
