...
use App\Http\Requests\Staff\StaffBookingRequest;
...
class BookingController extends Controller
{
        ...
        if(request()->ajax())
        {
            ...
            return DataTables::of($bookings)
                   ...
                   ->addColumn('actions', function($row) {
                    $new_row = collect($row);
                    $route_show = route('staff.bookings.show', $new_row['id']);
                    $btn = "
                    <div class='dropdown'>
    ...
    public function store(StaffBookingRequest $request, BookingService $service)
    {
        ...
        return to_route('staff.bookings.index')->with('success', 'Appointment for Walk-in Added Successfully');
    }

    public function show(Booking $booking)
    {
        return view('staff.booking.show', [
