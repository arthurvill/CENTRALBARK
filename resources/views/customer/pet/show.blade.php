...
@section('title', "$app_name | Pet Info")
                                                ...
                                                <div class='dropdown'>
                                                    ...
                                                    <div class='dropdown-menu dropdown-menu-right dropdown-menu-arrow'>
                                                        <a class='dropdown-item'
                                                            href='{{ route('customer.pets.vaccination_histories.edit', [$pet, $vaccination_history]) }}'>Edit
                                                        </a>
                                                        ...
                                                        <form
                                                            action="{{ route('customer.pets.vaccination_histories.destroy', [$pet, $vaccination_history]) }}"
                                                            method="POST"
                                ...
                                <tbody>
                                    @forelse ($bookings as $booking)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('customer.bookings.show', $booking) }}">
