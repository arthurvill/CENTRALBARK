...
class PaymentMethodController extends Controller
{
            ...
            return DataTables::of(PaymentMethod::all())
                   ...
                   ->addColumn('actions', function($row) {
                    ...
                    $btn = "
                     ...
                     $btn .= "<a class='dropdown-item' role='button' onclick='c_destroy($row->id,`admin.payment_methods.destroy`,`.payment_method_dt`)'>Delete</a>
                            </div>
                        </div> ";
    ...
    public function update(PaymentMethodRequest $request, PaymentMethod $payment_method)
    {
        if($request->option)
        {
            ...
            return $request->option == 'activate' ? $payment_method->update(['is_online' => 1]) 
