...
@section('content')
    <div class="container mt-5">
        ...
        <h4 class="text-center">
            <a class="text-dark text-decoration-none" href="{{ route('admin.bookings.show', $booking) }}?tab=tables">
        ...
        <div class="row mt-5">
            ...
            <div class="col-6 pr-5 ">
                ...
                <h6 class="font-weight-normal text-center">Veterinarian</h6>
    ...
    <script>
        ...
        onafterprint = function() {
            window.location.href = @json(route('admin.bookings.show', $booking));
        }
    </script>
@endsection
