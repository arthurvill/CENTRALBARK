        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb bg-light rounded shadow-sm px-3 py-2">
                <li class="breadcrumb-item">
                    <a href="{{ route('staff.pets.index') }}" class="text-decoration-none">
                        All Pets
                    </a>
                </li>
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="text-left mt-4">
                            ...
                            <p><strong>Owner:</strong> 
                                <a href="{{ route('staff.customers.show', $pet->customer) }}" class="text-decoration-none">{{ $pet->customer->full_name }}</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-8">
                <div class="card shadow-sm border-0">
                    ...
                    <h4 class="mb-0" style="color: white; font-weight: bold;">Vaccination History <i class="fas fa-history ml-2"></i></h4>
                        <a href="{{ route('staff.pets.vaccination_histories.create', $pet) }}" class="btn btn-sm btn-light float-right">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="{{ route('staff.pets.vaccination_histories.edit', [$pet, $vaccination_history]) }}">Edit</a>
                                                        ...
                                                        <form id="remove_vaccination_history-{{ $vaccination_history->id }}" action="{{ route('staff.pets.vaccination_histories.destroy', [$pet, $vaccination_history]) }}" method="POST" class="d-none">
                                                            @csrf @method('DELETE')
                                                        </form>
                                                    </div>
                                                </div>
                                ...
                                <tbody>
                                    @forelse ($bookings as $booking)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('staff.bookings.show', $booking) }}" class="text-decoration-none">
