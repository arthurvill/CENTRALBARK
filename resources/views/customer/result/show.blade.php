...
@section('title', "$app_name | $result->subject")
...
@section('content')
    ...
    <div class="container-fluid py-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('customer.bookings.show', $booking) }}">All
                        Results</a>
                </li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="font-weight-normal">Date Schedule : <span
                                ...
                                {{ formatDate($booking->schedule->date_time_start, 'time') }}
                                - {{ formatDate($booking->schedule->date_time_end, 'time') }}</span> </h3>
