                ...
                <div class="card w-100">
                    <div class="card-body d-flex and flex-column">
                        ...
                        <h3 class="font-weight-normal">Owner:
                            <a href="{{ route('admin.customers.show', $pet->customer) }}">{{ $pet->customer->full_name }}
                            </a>
                        </h3>
                            ...
                            <div class="col">
                                <h3 class="mb-0 text-gray font-weight-normal">Vaccination History <i
                                    ...
                                    <a class="float-right btn btn-sm btn-primary me-3"
                                        href="{{ route('admin.pets.vaccination_histories.create', $pet) }}">Add
                                                ...
                                                <div class='dropdown'>
                                                    ...
                                                    <div class='dropdown-menu dropdown-menu-right dropdown-menu-arrow'>
                                                        <a class='dropdown-item'
                                                            href='{{ route('admin.pets.vaccination_histories.edit', [$pet, $vaccination_history]) }}'>Edit
                                                        </a>
                                                        ...
                                                        <form
                                                            action="{{ route('admin.pets.vaccination_histories.destroy', [$pet, $vaccination_history]) }}"
                                                            method="POST"
                                ...
                                <tbody>
                                    @forelse ($bookings as $booking)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('admin.bookings.show', $booking) }}">
