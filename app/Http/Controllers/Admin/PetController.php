...
use App\Http\Requests\Pet\AdminPetRequest;
...
class PetController extends Controller
{
        ...
        if(request()->ajax())
        {
            ...
            return DataTables::of($pets)
                   ...
                   ->addColumn('actions', function($row) {
                    ...
                    $route_edit = route('admin.pets.edit', $new_row['id']);
                    ...
                    $btn = "
                        <div class='dropdown'>
                            ...
                            <div class='dropdown-menu dropdown-menu-right dropdown-menu-arrow'>
                                ...
                                <a class='dropdown-item' role='button' onclick='c_destroy($new_row[id],`admin.pets.destroy`,`.pet_dt`)'>Delete</a>
                            </div>
                        </div> ";
    ...
    public function store(AdminPetRequest $request, ImageUploadService $service)
    {
        ...
        return to_route('admin.pets.index')->with(['success' => 'Pet Added Successfully']);
    }
    ...
    public function update(AdminPetRequest $request, ImageUploadService $service, Pet $pet)
    {
        ...
        return to_route('admin.pets.index')->with(['success' => 'Pet Updated Successfully']);
