        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-0">
                    <a class="text-primary" href="{{ route('admin.bookings.index') }}"><i class="fas fa-arrow-left fa-lg"></i></a>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-7">
                            <img class="img-fluid d-none d-lg-block mx-md-auto" src="{{ asset('img/booking/create.svg') }}" alt="book_schedule">
                        </div>
                        <div class="col-md-4">
                            <h1 class="text-primary font-weight-normal">Create Appointment for Walk-in <i class="fas fa-clipboard-list ml-1"></i></h1>
                            <form action="{{ route('admin.bookings.store') }}" method="post" enctype="multipart/form-data" id="booking_form">
                                @csrf

                                @include('layouts.includes.alert')
                                <br>

                                <!-- Pet Selection - Optional for Walk-ins -->
                                ...
                                <!-- Status (for walk-in booking) -->
                                <div class="form-group mb-3">
                                    <input type="hidden" name="status" value="walk-in"> <!-- Hidden field for walk-in status -->
                                </div>
